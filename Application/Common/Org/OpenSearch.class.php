...
class OpenSearch {
     ...
     * @var string
     */
    private $private_url = " http://intranet.opensearch-cn-hangzhou.aliyuncs.com";
     ...
     * @return array|mixed
     */
    public function search($keyword, $sort, $filter = null, $start_num = 0, $page_size = 0, $distinct = array()) {
        // 实例化一个搜索类
     ...
     * @return int
     */
    public function searchCount($keyword, $filter = null, $distinct = array()) {
        // 实例化一个搜索类
        $searchClient = new SearchClient(self::$client);
        // 实例化一个搜索参数类
        $params = new SearchParamsBuilder();
