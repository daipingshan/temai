...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <form class="layui-form xbs" action="<?php echo U('SaleArticle/historyArticle');?>" name="search">
            ...
            <div class="layui-form-item" style="display: inline-block;">
                <div class="layui-input-inline">
                    <select name="week">
                        ...
                        <option value="1"
                        <?php if(I('get.week') == 1): ?>selected<?php endif; ?>
                        >星期一</option>
                        <option value="2"
                        <?php if(I('get.week') == 2): ?>selected<?php endif; ?>
                        >星期二</option>
                        <option value="3"
                        <?php if(I('get.week') == 3): ?>selected<?php endif; ?>
                        >星期三</option>
                        <option value="4"
                        <?php if(I('get.week') == 4): ?>selected<?php endif; ?>
                        >星期四</option>
                        <option value="5"
                        <?php if(I('get.week') == 5): ?>selected<?php endif; ?>
                        >星期五</option>
                        <option value="6"
                        <?php if(I('get.week') == 6): ?>selected<?php endif; ?>
                        >星期六</option>
                        <option value="7"
                        <?php if(I('get.week') == 7): ?>selected<?php endif; ?>
                        >星期天</option>
                    </select>
                </div>
    ...
    <?php if(I('get.submit') == 2): ?><div class="layui-row layui-col-space5">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="layui-col-md3" style="height: 1000px;overflow: scroll">
                    <table class="layui-table">
                        ...
                        <tbody>
                        <?php if(is_array($row["data"])): $i = 0; $__LIST__ = $row["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td>
                                    <?php echo (date("Y-m-d H:i:s",$vo["behot_time"])); ?>【<?php echo ($vo["go_detail_count"]); ?>】
                                    <br>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <button class="layui-btn layui-btn-sm" style="background:rgba(0,0,0,0.4)"
                                data-url="<?php echo U('TopLine/openArticleDetail',array('id'=>$vo['article_id']));?>"
