...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <fieldset class="layui-elem-field">
        <legend>图集页面地址:<a href="<?php echo ($location_url); ?>" target="_blank"><?php echo ($title); ?></a></legend>
        <div class="layui-field-box">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><h3>商品标题：<?php echo ($row["title"]); ?></h3>
                ...
                <p>商品价格：<span style="color: #FF5722;margin-right: 200px"><?php echo ($row["price"]); ?></span> 商品平台：<span
                        style="color: #1E9FFF;"><?php echo ($row["shop_type_name"]); ?></span>
                </p>
                <div style="width: 200px;margin: 10px auto">
                    <img src="<?php echo ($row["img"]); ?>" style="width: 200px"/>
                </div>
                <hr class="layui-bg-green"><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </fieldset>
