    ...
    <form class="layui-form">
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <input type="text" name="userid" placeholder="请输入账号user_id" class="layui-input"
                <?php if(!empty($info)): ?>value="<?php echo ($info['userid']); ?>"<?php endif; ?>
                >
            </div>
        </div>
...
<!-- 中部结束 -->
    ...
    <script type="text/javascript">
        ...
        form.on('submit(save)', function (data) {
            ...
            var url = "<?php echo U('Sale/saveAccount');?>";
