...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <form class="layui-form xbs" action="<?php echo U('Order/orderCount');?>">
        <div class="layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <?php if(is_array($user_data)): foreach($user_data as $user_id=>$name): if(in_array($user_id,$user_ids)): ?><input type="checkbox" name="user_id[]" title="<?php echo ($name); ?>" value="<?php echo ($user_id); ?>"
                                   checked="checked">
                            <?php else: ?>
                            <input type="checkbox" name="user_id[]" title="<?php echo ($name); ?>" value="<?php echo ($user_id); ?>"><?php endif; endforeach; endif; ?>
                </div>
            </div>
