...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
        ...
        <div class="layui-form-pane">
            <div class="layui-form-item" style="display: inline-block;">
                <div class="layui-input-inline" style="width: 700px">
                    <input type="text" name="url" placeholder="请输入商头条链接商品" autocomplete="off"
                           class="layui-input" value="<?php echo I('get.url');?>">
                </div>
    ...
    <?php if(!empty($info)): ?><fieldset class="layui-elem-field">
            <legend>错误</legend>
