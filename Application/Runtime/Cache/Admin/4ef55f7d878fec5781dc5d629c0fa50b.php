...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <form class="layui-form xbs" action="<?php echo U('Order/count');?>">
            ...
            <div class="layui-form-item" style="display: inline-block;text-align: center">
                ...
                <div class="layui-input-inline">
                    <select name="time">
                        ...
                        <option value="2"
                        <?php if(I('get.time') == $k): ?>selected<?php endif; ?>
                        >昨天</option>
                        <option value="3"
                        <?php if(I('get.time') == $k): ?>selected<?php endif; ?>
                        >前天</option>
                ...
                <?php if(($group_id) == "1"): ?><div class="layui-input-inline">
                        <select name="user_id">
                            <option>请选择用户</option>
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="times" class="layui-input" placeholder="请选择时间范围" id="time"
                               value="<?php echo I('get.times','','urldecode');?>">
                    </div><?php endif; ?>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <button class="layui-btn layui-btn-sm claim" style="background-color: rgba(0,0,0,0.4)"
                            title="查看商品" data-id="<?php echo ($vo["id"]); ?>"  data-url="<?php echo U('Sale/goodsInfo');?>?id=<?php echo ($vo['id']); ?>&time=<?php echo ($time); ?>" onclick="location.href=$(this).data('url')">
