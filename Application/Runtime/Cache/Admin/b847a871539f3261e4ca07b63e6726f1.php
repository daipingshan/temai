...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <form class="layui-form xbs" action="<?php echo U('SaleArticle/count');?>" name="search">
        ...
        var option = {
            ...
            series: [
                ...
                },
                {
                    ...
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($one_w_num); ?>
                },
                {
                    name: '20-30w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($two_w_num); ?>
                },
                {
                    name: '30-40w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($three_w_num); ?>
                },
                {
                    name: '40-50w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($four_w_num); ?>
                },
                {
                    name: '50-60w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($five_w_num); ?>
                },
                {
                    name: '60-70w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($six_w_num); ?>
                },
                {
                    name: '70-80w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($seven_w_num); ?>
                },
                {
                    name: '80-90w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($eight_w_num); ?>
                },
                {
                    name: '90-100w',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($nine_w_num); ?>
                },
                {
                    name: '100w以上',
                    type: 'line',
                    itemStyle: {normal: {areaStyle: {type: 'default'}}},
                    data: <?php echo ($ten_w_num); ?>
                }
            ]
        };
        // 为echarts对象加载数据
