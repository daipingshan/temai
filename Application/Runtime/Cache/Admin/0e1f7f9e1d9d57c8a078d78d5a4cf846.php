                ...
                <div class="layui-field-box">
                    <form class="layui-form" action="">
                        ...
                        <?php if(($group_id) == "1"): ?><div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="source_id" value="<?php echo ($source_id); ?>" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div><?php endif; ?>
                        <div class="layui-form-item">
    ...
    <script>
        $(function () {
            ...
            form.on('submit(save)', function (data) {
                ...
                var url = "<?php echo U('TopLine/saveNews');?>";
                _this.text('正在保存中...');
                $.post(url, data.field, function (res) {
                    layer.msg(res.info);
                    if (res.status == 1) {
                        setTimeout(function () {
                            window.parent.location.href = "<?php echo U('TopLine/newsList');?>";
                        }, 3000)
                    } else {
                        _this.text('保存');
