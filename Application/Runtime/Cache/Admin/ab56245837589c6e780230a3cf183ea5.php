...
<div class="wrapper" style="position: relative;margin-top:70px;margin-bottom: 50px">
    ...
    <xblock>
        <button class="layui-btn" style="background-color: rgba(0,0,0,0.4)"
                onclick="x_admin_show('添加账号','<?php echo U('Sale/addAccount');?>','800','500')"><i
    ...
    <table class="layui-table">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a title="编辑" href="javascript:;" data-url="<?php echo U('Sale/updateAccount',array('id'=>$vo['id']));?>"
                    ...
                    <a title="查看" href="javascript:;" class="open-info"
                       style="text-decoration:none" data-url="<?php echo U('Sale/openInfo',array('id'=>$vo['id']));?>">
                        <i class="layui-icon" style="font-size: 20px;color: #fff">&#xe60a;</i>
                    </a>
                </td>
    ...
    <script type="text/javascript">
        ...
        function member_del(id) {
            layer.confirm('确认要删除该账号吗？', {title: "删除确认"}, function (index) {
                $.post("<?php echo U('TopLine/deleteAccount');?>", {id: id}, function (res) {
                    if (res.status == 1) {
